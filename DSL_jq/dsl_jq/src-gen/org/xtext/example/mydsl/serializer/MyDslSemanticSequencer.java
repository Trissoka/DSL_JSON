...
public class MyDslSemanticSequencer extends AbstractDelegatingSemanticSequencer {
	...
	protected void sequence_CountJson(ISerializationContext context, CountJson semanticObject) {
		if (errorAcceptor != null) {
			...
			if (transientValues.isValueTransient(semanticObject, MyDslPackage.Literals.COUNT_JSON__PATH) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, MyDslPackage.Literals.COUNT_JSON__PATH));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getCountJsonAccess().getCountJSONCountKeyword_0_0(), semanticObject.getCountJSON());
		feeder.accept(grammarAccess.getCountJsonAccess().getPathSTRINGTerminalRuleCall_2_0(), semanticObject.getPath());
		feeder.finish();
	}
	...
	protected void sequence_ReadJson(ISerializationContext context, ReadJson semanticObject) {
		...
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getReadJsonAccess().getReadJSONReadJSONKeyword_0_0(), semanticObject.getReadJSON());
	...
	protected void sequence_Remove(ISerializationContext context, Remove semanticObject) {
		if (errorAcceptor != null) {
			...
			if (transientValues.isValueTransient(semanticObject, MyDslPackage.Literals.REMOVE__TAB_NAME) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, MyDslPackage.Literals.REMOVE__TAB_NAME));
		...
		feeder.accept(grammarAccess.getRemoveAccess().getTabNameSTRINGTerminalRuleCall_4_0(), semanticObject.getTabName());
		feeder.accept(grammarAccess.getRemoveAccess().getFileSTRINGTerminalRuleCall_6_0(), semanticObject.getFile());
		feeder.finish();
	}
	...
	protected void sequence_WriteCSV(ISerializationContext context, WriteCSV semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, MyDslPackage.Literals.WRITE_CSV__WRITE_CSV) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, MyDslPackage.Literals.WRITE_CSV__WRITE_CSV));
			...
			if (transientValues.isValueTransient(semanticObject, MyDslPackage.Literals.WRITE_CSV__TAB_NAME) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, MyDslPackage.Literals.WRITE_CSV__TAB_NAME));
			if (transientValues.isValueTransient(semanticObject, MyDslPackage.Literals.WRITE_CSV__HEADER) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, MyDslPackage.Literals.WRITE_CSV__HEADER));
			if (transientValues.isValueTransient(semanticObject, MyDslPackage.Literals.WRITE_CSV__OUTPUT_FILE) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, MyDslPackage.Literals.WRITE_CSV__OUTPUT_FILE));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getWriteCSVAccess().getWriteCSVWriteCSVKeyword_0_0(), semanticObject.getWriteCSV());
		feeder.accept(grammarAccess.getWriteCSVAccess().getPathSTRINGTerminalRuleCall_2_0(), semanticObject.getPath());
		feeder.accept(grammarAccess.getWriteCSVAccess().getTabNameSTRINGTerminalRuleCall_4_0(), semanticObject.getTabName());
		feeder.accept(grammarAccess.getWriteCSVAccess().getHeaderSTRINGTerminalRuleCall_6_0(), semanticObject.getHeader());
		feeder.accept(grammarAccess.getWriteCSVAccess().getOutputFileSTRINGTerminalRuleCall_8_0(), semanticObject.getOutputFile());
		feeder.finish();
	}
