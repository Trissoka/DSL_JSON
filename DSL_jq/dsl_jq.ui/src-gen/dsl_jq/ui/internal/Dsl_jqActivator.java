 ...
 * introduced subclass. 
 */
public class Dsl_jqActivator extends AbstractUIPlugin {

	public static final String PLUGIN_ID = "dsl_jq.ui";
	public static final String ORG_XTEXT_EXAMPLE_MYDSL_MYDSL = "org.xtext.example.mydsl.MyDsl";
	
	private static final Logger logger = Logger.getLogger(Dsl_jqActivator.class);
	
	private static Dsl_jqActivator INSTANCE;
	...
	public static Dsl_jqActivator getInstance() {
		return INSTANCE;
	}
